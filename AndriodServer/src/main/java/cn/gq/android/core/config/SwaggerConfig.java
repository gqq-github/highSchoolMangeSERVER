...
//        params.add(tokenParam2.build());
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(predicate)//也可以直接这样设置RequestHandlerSelectors.basePackage("com.geovis.*.controller")
                 //.apis(RequestHandlerSelectors.basePackage("com.geovis.controller.system"))
                .build()
