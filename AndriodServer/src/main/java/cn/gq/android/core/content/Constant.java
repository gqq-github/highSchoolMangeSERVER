package cn.gq.android.core.content;
...
public class Constant {
    ...
    //返回头信息
    public static final String HEADER_ERROR = "X-myApp-error";
    public static final String HEADER_ALERT = "X-myApp-alert";
    public static final String HEADER_PARAM = "X-myApp-param";
